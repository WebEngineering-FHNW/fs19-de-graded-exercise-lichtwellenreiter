...
class BootStrap {
    ...
    def init = { servletContext ->
         ...
         * Add Module Data
         */
        save(Module.findOrCreateWhere(name: "Objectoriented Programming 1", abbreviation: "oop1", msp: true, credits: 3, type: "base", description: "-"))
        ...
        save(Module.findOrCreateWhere(name: "Functional Programming", abbreviation: "fprog", msp: true, credits: 3, type: "base", description: "-"))
